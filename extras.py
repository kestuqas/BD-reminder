COMMAND_HELP ='This is a birtday reminder app, sending e-mail messages to recipients through Gmail server.\
...
OPTION_DATA = "Use this option to set the data file path."
OPTION_SEND = "Use this option and type 'True' to send reminders."
